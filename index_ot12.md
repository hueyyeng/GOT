...
Recently, the **Stygian Abyss** was introduce as a new permanent combat challenge event that resets every version.
...
New to Nod-Krai, Lunar reactions blah blah blah.
...
Each playable Nod-Krai characters have their own Lunar reaction exclusive to them.

New changes to Nod-Krai storyline presentation allows the devs to integrate character stories into the main story.
...
Version 5.8 broke the trend which introduce Easybreeze Holiday Resort as a permanent summer event so new players can experience the vibrant summer vacation anytime.
...
Released in Version 1.5, the Serenitea Pot allows player to create their own home from various furniture crafted through materials and blueprints found in Teyvat.
...
Genshin Impact is available now on PS5, PC, Android, iOS and Xbox Series X/S. A Switch version has also been announced without a specific date as of yet.
